...
const AddTaskDialog = ({ isOpen, closeDialog }) => {
  ...
  return (
    <>
      {createPortal(
        <div className="fixed top-0 left-0 backdrop-blur-[2px] bg-[#00000040] w-screen h-screen z-50 flex justify-center items-center">
          <div className="w-[336px] h-[430px] bg-white rounded-2xl flex flex-col items-center gap-4 p-5 relative z-50 shadow-sm">
            ...
            <Input label="Titulo" id="title" placeholder="Título da Tarefa" />
